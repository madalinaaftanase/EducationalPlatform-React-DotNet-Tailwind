function ResultContainer({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-gray-400 border-4 h-[83%] rounded">
      <div className=" bg-gray-300 border-b-2 border-gray-400">
        ...
        <div className="flex gap-1 items-center border-t-2 border-gray-200 ">
          <svg
          ...
          <span className="bg-gray-100 pr-24 rounded">https://localhost:3000/PaginaMea</span>
        </div>
      </div>
      <div>{children}</div>
    </div>
